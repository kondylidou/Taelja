...
-- Goal 1
theorem taelja_goal1 : ∀ (x : α) (y : α) (z : α), (mult x (ld y y)) = x := by
  intro x y z
  calc mult x (ld y y) = rd (mult (mult x (ld y y)) (ld (mult x (ld y y)) (mult x (ld y y)))) (ld (mult x (ld y y)) (mult x (ld y y))) := by first | (first | (exact ax5 (mult x (ld y y)) (ld (mult x (ld y y)) (mult x (ld y y)))) | (exact Eq.symm (ax5 (mult x (ld y y)) (ld (mult x (ld y y)) (mult x (ld y y)))))) | (have h_rw := ax5 (mult x (ld y y)) (ld (mult x (ld y y)) (mult x (ld y y))); rw [h_rw])
      ...
      _ = rd (mult x (ld y y)) (rd (mult (ld (mult x (ld y y)) (mult x (ld y y))) z) z) := by first | (first | (exact ax5 (ld (mult x (ld y y)) (mult x (ld y y))) z) | (exact Eq.symm (ax5 (ld (mult x (ld y y)) (mult x (ld y y))) z))) | (have h_rw := ax5 (ld (mult x (ld y y)) (mult x (ld y y))) z; rw [h_rw])
      _ = rd (mult x (ld y y)) (rd z z) := by first | (first | (exact taelja_lemma6 (mult x (ld y y)) z) | (exact Eq.symm (taelja_lemma6 (mult x (ld y y)) z))) | (have h_rw := taelja_lemma6 (mult x (ld y y)) z; rw [h_rw])
      _ = rd (mult x (ld y y)) (rd (mult (ld y y) z) z) := by first | (first | (exact taelja_lemma6 y z) | (exact Eq.symm (taelja_lemma6 y z))) | (have h_rw := taelja_lemma6 y z; rw [h_rw])
      _ = rd (mult x (ld y y)) (ld y y) := by first | (first | (exact ax5 (ld y y) z) | (exact Eq.symm (ax5 (ld y y) z))) | (have h_rw := ax5 (ld y y) z; rw [h_rw])
