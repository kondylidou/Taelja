...
theorem taelja_lemma12 : ∀ (x : α), (c_plus c_0 x t_b) = x := by
  ...
  have h3 : (c_plus c_0 x t_b) = x := by first | (exact ax8 t_b x h2) | (first | (exact ax8 _ _ h2) | (apply ax8 <;> (first | assumption | rfl | exact Eq.symm (by assumption) | exact Eq.trans (by assumption) (by assumption) | exact Eq.trans (Eq.symm (by assumption)) (by assumption) | exact Eq.trans (by assumption) (Eq.symm (by assumption)) | exact Eq.trans (Eq.symm (by assumption)) (Eq.symm (by assumption)) | exact taelja_elem)) | (apply Eq.symm; apply ax8 <;> (first | assumption | rfl | exact Eq.symm (by assumption) | exact Eq.trans (by assumption) (by assumption) | exact Eq.trans (Eq.symm (by assumption)) (by assumption) | exact Eq.trans (by assumption) (Eq.symm (by assumption)) | exact Eq.trans (Eq.symm (by assumption)) (Eq.symm (by assumption)) | exact taelja_elem)))
  exact h3

-- Lemma 13
theorem taelja_lemma13 : c_lessequals (v_g v_x) (v_k v_x) t_b := by
  have h1 : class_Ring__and__Field_Oordered__idom t_b := by first | (exact ax1) | (first | apply ax1 <;> first | rfl | assumption)
...
-- Lemma 14
theorem taelja_lemma14 : c_lessequals (c_plus c_0 (v_g v_x) t_b) (v_f v_x) t_b := by
  have h1 : class_Ring__and__Field_Oordered__idom t_b := by first | (exact ax1) | (first | apply ax1 <;> first | rfl | assumption)
...
theorem taelja_goal1 : c_lessequals c_0 (c_minus (v_f v_x) (v_g v_x) t_b) t_b := by
  have h1 : class_Ring__and__Field_Oordered__idom t_b := by first | (exact ax1) | (first | apply ax1 <;> first | rfl | assumption)
  have h2 : class_OrderedGroup_Opordered__ab__group__add t_b := by first | (exact ax2 t_b h1) | (first | (exact ax2 _ h1) | (apply ax2 <;> (first | assumption | rfl | exact Eq.symm (by assumption) | exact Eq.trans (by assumption) (by assumption) | exact Eq.trans (Eq.symm (by assumption)) (by assumption) | exact Eq.trans (by assumption) (Eq.symm (by assumption)) | exact Eq.trans (Eq.symm (by assumption)) (Eq.symm (by assumption)) | exact taelja_elem)))
  have h3 : c_lessequals (c_plus c_0 (v_g v_x) t_b) (v_f v_x) t_b := by first | (exact taelja_lemma14) | (first | apply taelja_lemma14 <;> first | rfl | assumption)
  have h4 : c_lessequals c_0 (c_minus (v_f v_x) (v_g v_x) t_b) t_b := by first | (exact ax11 (v_f v_x) t_b c_0 (v_g v_x) h2 h3) | (first | (exact ax11 _ _ _ _ h2 h3) | (apply ax11 <;> (first | assumption | rfl | exact Eq.symm (by assumption) | exact Eq.trans (by assumption) (by assumption) | exact Eq.trans (Eq.symm (by assumption)) (by assumption) | exact Eq.trans (by assumption) (Eq.symm (by assumption)) | exact Eq.trans (Eq.symm (by assumption)) (Eq.symm (by assumption)) | exact taelja_elem)))
  exact h4
