...
fof(lemma_8, lemma, p3(f4(f9(c16)),f6(f8(f9(c16)))), inference(mp, [status(thm)], [p3_18, s1])).
fof(lemma_9, lemma, p10(f4(f9(c16)),f4(c16)), inference(mp, [status(thm)], [p10_19, c16_is_p11_3])).
fof(goal_1, theorem, p11(f9(c16)), inference(mp, [status(thm)], [p11_9, c16_is_p11_3])).
fof(s2, plain, p10(f6(f8(f9(c16))),f6(c15)), inference(mp, [status(thm)], [p10_26, lemma_8, p3_8, lemma_9])).
fof(goal_2, theorem, p12(f8(f9(c16)),c15), inference(mp, [status(thm)], [p12_11, s2])).
fof(s3, plain, p11(f9(c16)), inference(mp, [status(thm)], [p11_9, c16_is_p11_3])).
fof(goal_3, theorem, p3(f4(f9(c16)),f6(f8(f9(c16)))), inference(mp, [status(thm)], [p3_18, s3])).
