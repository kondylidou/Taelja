...
fof(s1, plain, class_OrderedGroup_Ocomm__monoid__add(t_b), inference(mp, [status(thm)], [clsrel_Ring__and__Field_Oordered__idom_23, tfree_tcs])).
fof(lemma_13, lemma, ! [X] : c_plus(c_0,X,t_b) = X, inference(mp, [status(thm)], [cls_OrderedGroup_Ocomm__monoid__add__class_Oaxioms_0, s1])).
fof(s2, plain, class_OrderedGroup_Olordered__ab__group__abs(t_b), inference(mp, [status(thm)], [clsrel_Ring__and__Field_Oordered__idom_50, tfree_tcs])).
fof(s3, plain, class_OrderedGroup_Opordered__ab__group__add(t_b), inference(mp, [status(thm)], [clsrel_OrderedGroup_Olordered__ab__group__abs_1, s2])).
fof(s4, plain, c_lessequals(c_plus(c_0,v_k(v_x),t_b),v_f(v_x),t_b), inference(mp, [status(thm)], [cls_OrderedGroup_Ocompare__rls__9_0, s3, cls_conjecture_1])).
fof(lemma_14, lemma, c_lessequals(v_k(v_x),v_f(v_x),t_b), inference(rewrite, [status(thm)], [lemma_13, s4])).
fof(s5, plain, class_OrderedGroup_Olordered__ab__group__abs(t_b), inference(mp, [status(thm)], [clsrel_Ring__and__Field_Oordered__idom_50, tfree_tcs])).
fof(s6, plain, class_LOrder_Ojoin__semilorder(t_b), inference(mp, [status(thm)], [clsrel_OrderedGroup_Olordered__ab__group__abs_15, s5])).
fof(s7, plain, class_Orderings_Oorder(t_b), inference(mp, [status(thm)], [clsrel_LOrder_Ojoin__semilorder_1, s6])).
fof(s8, plain, c_lessequals(v_g(v_x),v_f(v_x),t_b), inference(mp, [status(thm)], [cls_Orderings_Oorder__class_Oorder__trans_0, s7, lemma_14, cls_conjecture_2])).
fof(lemma_15, lemma, c_lessequals(c_plus(c_0,v_g(v_x),t_b),v_f(v_x),t_b), inference(rewrite, [status(thm)], [lemma_13, s8])).
fof(s9, plain, class_OrderedGroup_Olordered__ab__group__abs(t_b), inference(mp, [status(thm)], [clsrel_Ring__and__Field_Oordered__idom_50, tfree_tcs])).
fof(s10, plain, class_OrderedGroup_Opordered__ab__group__add(t_b), inference(mp, [status(thm)], [clsrel_OrderedGroup_Olordered__ab__group__abs_1, s9])).
fof(goal_1, theorem, c_lessequals(c_0,c_minus(v_f(v_x),v_g(v_x),t_b),t_b), inference(mp, [status(thm)], [cls_OrderedGroup_Ocompare__rls__9_1, s10, lemma_15])).
