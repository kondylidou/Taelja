...
fof(lemma_11, lemma, sorti2(h(esk1_0)), inference(mp, [status(thm), assumptions([c_0_13])], [c_0_13, axiom_1])).
fof(lemma_12, lemma, sorti2(esk2_1(h(esk1_0))), inference(mp, [status(thm), assumptions([c_0_13])], [axiom_6, lemma_11])).
fof(s1, plain, sorti2(esk2_1(h(esk1_0))), inference(mp, [status(thm), assumptions([c_0_13])], [axiom_6, lemma_11])).
fof(s2, plain, sorti2(op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0)))), inference(mp, [status(thm), assumptions([c_0_13])], [ax2, s1, lemma_12])).
fof(lemma_13, lemma, h(j(op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0))))) = op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0))), inference(mp, [status(thm), assumptions([c_0_14, c_0_13])], [c_0_14, s2])).
fof(lemma_14, lemma, j(op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0)))) = op1(j(esk2_1(h(esk1_0))),j(esk2_1(h(esk1_0)))), inference(mp, [status(thm), assumptions([c_0_9, c_0_13])], [c_0_9, lemma_12, lemma_12])).
fof(s3, plain, sorti1(j(esk2_1(h(esk1_0)))), inference(mp, [status(thm), assumptions([c_0_10, c_0_13])], [c_0_10, lemma_12])).
fof(lemma_15, lemma, op1(j(esk2_1(h(esk1_0))),j(esk2_1(h(esk1_0)))) = esk1_0, inference(mp, [status(thm), assumptions([c_0_10, c_0_13])], [axiom_2, s3])).
fof(s4, plain, op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0))) = h(j(op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0))))), inference(instantiate, [status(thm), assumptions([c_0_14, c_0_13])], [lemma_13])).
fof(s5, plain, op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0))) = h(op1(j(esk2_1(h(esk1_0))),j(esk2_1(h(esk1_0))))), inference(rewrite, [status(thm), assumptions([c_0_9, c_0_13, c_0_14])], [lemma_14, s4])).
fof(lemma_16, lemma, op2(esk2_1(h(esk1_0)),esk2_1(h(esk1_0))) = h(esk1_0), inference(rewrite, [status(thm), assumptions([c_0_10, c_0_13, c_0_9, c_0_14])], [lemma_15, s5])).
fof(s6, plain, $false, inference(mp, [status(thm), assumptions([c_0_13, c_0_10, c_0_9, c_0_14])], [axiom_10, lemma_11, lemma_16])).
fof(co1, theorem, (! [X1]: (sorti1(X1) => sorti2(h(X1))) & ! [X2]: (sorti2(X2) => sorti1(j(X2)))) => ~ (! [X3]: (sorti1(X3) => ! [X4]: (sorti1(X4) => h(op1(X3, X4)) = op2(h(X3), h(X4)))) & ! [X5]: (sorti2(X5) => ! [X6]: (sorti2(X6) => j(op2(X5, X6)) = op1(j(X5), j(X6)))) & ! [X7]: (sorti2(X7) => h(j(X7)) = X7) & ! [X8]: (sorti1(X8) => j(h(X8)) = X8)), inference(implies, [status(thm), discharge(implies, [c_0_13, c_0_12, c_0_9, c_0_10, c_0_14])], [s6, c_0_13, c_0_12, c_0_9, c_0_10, c_0_14])).
