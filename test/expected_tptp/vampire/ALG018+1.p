...
fof(lemma_12, lemma, op1(j(sK1(h(sK0))),j(sK1(h(sK0)))) = sK0, inference(mp, [status(thm), assumptions([f24, f25])], [axiom_5, s4])).
...
fof(s9, plain, sK0 = op1(j(sK1(h(sK0))),j(sK1(h(sK0)))), inference(instantiate, [status(thm), assumptions([f24, f25])], [lemma_12])).
fof(s10, plain, sK0 = j(op2(sK1(h(op1(j(sK1(h(sK0))),j(sK1(h(sK0)))))),sK1(h(sK0)))), inference(rewrite, [status(thm), assumptions([f24, f25, f28])], [lemma_14, s9])).
fof(lemma_15, lemma, sK0 = j(op2(sK1(h(sK0)),sK1(h(sK0)))), inference(rewrite, [status(thm), assumptions([f24, f25, f28])], [lemma_12, s10])).
fof(s11, plain, sorti2(op2(sK1(h(sK0)),sK1(h(sK0)))), inference(mp, [status(thm), assumptions([f25])], [f2, lemma_11, lemma_11])).
fof(s12, plain, sorti2(op2(sK1(h(j(op2(sK1(h(sK0)),sK1(h(sK0)))))),sK1(h(sK0)))), inference(rewrite, [status(thm), assumptions([f24, f25, f28])], [lemma_15, s11])).
fof(s13, plain, sorti2(op2(sK1(h(sK0)),sK1(h(sK0)))), inference(rewrite, [status(thm), assumptions([f24, f25, f28])], [lemma_15, s12])).
...
fof(lemma_16, lemma, h(j(op2(sK1(h(j(op2(sK1(h(sK0)),sK1(h(sK0)))))),sK1(h(sK0))))) = op2(sK1(h(sK0)),sK1(h(sK0))), inference(rewrite, [status(thm), assumptions([f24, f25, f28, f27])], [lemma_15, s14])).
fof(s15, plain, op2(sK1(h(sK0)),sK1(h(sK0))) = h(j(op2(sK1(h(j(op2(sK1(h(sK0)),sK1(h(sK0)))))),sK1(h(sK0))))), inference(instantiate, [status(thm), assumptions([f24, f25, f28, f27])], [lemma_16])).
fof(s16, plain, op2(sK1(h(sK0)),sK1(h(sK0))) = h(j(op2(sK1(h(sK0)),sK1(h(sK0))))), inference(rewrite, [status(thm), assumptions([f24, f25, f28, f27])], [lemma_15, s15])).
fof(lemma_17, lemma, op2(sK1(h(sK0)),sK1(h(sK0))) = h(sK0), inference(rewrite, [status(thm), assumptions([f24, f25, f28, f27])], [lemma_15, s16])).
fof(s17, plain, $false, inference(mp, [status(thm), assumptions([f24, f25, f28, f27])], [axiom_9, lemma_17, lemma_10])).
