...
fof(lemma_10, lemma, sK1 = j(h(sK1)), inference(mp, [status(thm), assumptions([f25])], [f25, axiom_1])).
...
fof(s8, plain, sK1 = j(op2(h(j(h(sK1))),h(sK1))), inference(rewrite, [status(thm), assumptions([f25, f24, f28])], [lemma_13, lemma_10])).
fof(s9, plain, sK1 = j(op2(h(sK1),h(sK1))), inference(rewrite, [status(thm), assumptions([f25, f24, f28])], [lemma_10, s8])).
fof(s10, plain, sK1 = j(h(op1(j(h(sK1)),sK1))), inference(rewrite, [status(thm), assumptions([f25, f28, f24])], [lemma_14, s9])).
fof(s11, plain, sK1 = j(h(op1(sK1,sK1))), inference(rewrite, [status(thm), assumptions([f25, f28, f24])], [lemma_10, s10])).
fof(lemma_16, lemma, sK1 = op1(sK1,sK1), inference(rewrite, [status(thm), assumptions([f25, f28, f24])], [lemma_15, s11])).
fof(s12, plain, $false, inference(mp, [status(thm), assumptions([f25, f28, f24])], [axiom_9, lemma_16])).
fof(f5, theorem, (! [X0]: (sorti1(X0) => sorti2(h(X0))) & ! [X1]: (sorti2(X1) => sorti1(j(X1)))) => ~ (! [X2]: (sorti1(X2) => ! [X3]: (sorti1(X3) => h(op1(X2, X3)) = op2(h(X2), h(X3)))) & ! [X4]: (sorti2(X4) => ! [X5]: (sorti2(X5) => j(op2(X4, X5)) = op1(j(X4), j(X5)))) & ! [X6]: (sorti2(X6) => h(j(X6)) = X6) & ! [X7]: (sorti1(X7) => j(h(X7)) = X7)), inference(implies, [status(thm), discharge(implies, [f25, f24, f28])], [s12, f25, f24, f28])).
