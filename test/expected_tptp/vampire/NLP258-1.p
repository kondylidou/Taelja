...
fof(lemma_25, lemma, ! [X] : present(skc12,skf2(X)), inference(mp, [status(thm)], [f92, s1])).
fof(s2, plain, man(skc12,skc15), inference(mp, [status(thm)], [f52, f84, f74])).
fof(lemma_26, lemma, ! [X] : smoke(skc12,skf2(X)), inference(mp, [status(thm)], [f91, s2])).
...
fof(s4, plain, smoke(skc12,skf2(skc10)), inference(instantiate, [status(thm)], [lemma_26])).
fof(lemma_28, lemma, event(skc12,skf2(skc10)), inference(mp, [status(thm)], [f1, s4])).
...
fof(s5, plain, smoke(skc12,skf2(skf4(skc12))), inference(instantiate, [status(thm)], [lemma_26])).
fof(goal_1, theorem, event(skc12,skf2(skf4(skc12))), inference(mp, [status(thm)], [f1, s5])).
fof(s6, plain, smoke(skc12,skf2(skc10)), inference(instantiate, [status(thm)], [lemma_26])).
fof(goal_2, theorem, event(skc12,skf2(skc10)), inference(mp, [status(thm)], [f1, s6])).
fof(s7, plain, man(skc12,skc10), inference(mp, [status(thm)], [f52, f84, f82])).
fof(goal_3, theorem, agent(skc12,skf2(skc10),skc10), inference(mp, [status(thm)], [f94, s7])).
fof(s8, plain, smoke(skc12,skf2(skc10)), inference(instantiate, [status(thm)], [lemma_26])).
fof(s9, plain, present(skc12,skf2(skc10)), inference(instantiate, [status(thm)], [lemma_25])).
fof(s10, plain, man(skc12,skf4(skc12)), inference(mp, [status(thm)], [f95, f90, f82, f83, s8, s9, lemma_27, lemma_28, lemma_29, f80, f89, f84, f85, f85, f84, f79, f78, f77, f88, f87, f87, f74, f86, f76, lemma_30, f88, f77, f78, f79, f73])).
fof(goal_4, theorem, agent(skc12,skf2(skf4(skc12)),skf4(skc12)), inference(mp, [status(thm)], [f94, s10])).
