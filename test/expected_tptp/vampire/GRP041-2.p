...
fof(f1, axiom, ! [X0]: product(identity, X0, X0), file('Problems/GRP/GRP041-2.p', unknown)).
fof(f4, axiom, ! [X2, X3, X0, X1]: (~ product(X0, X1, X3) | ~ product(X0, X1, X2) | equalish(X2, X3)), file('Problems/GRP/GRP041-2.p', unknown)).
